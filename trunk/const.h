...
#define MAP_PIC_MAX_OFFSET_X		200
#define MAP_PIC_MAX_OFFSET_Y		MAP_PIC_MAX_OFFSET_X
#define MAP_PIC_MAX_OFFSET_CELL_X	((float)MAP_PIC_MAX_OFFSET_X / CELL_WIDTH + .5f)
#define MAP_PIC_MAX_OFFSET_CELL_Y	((float)MAP_PIC_MAX_OFFSET_Y / CELL_HEIGHT + .5f)
